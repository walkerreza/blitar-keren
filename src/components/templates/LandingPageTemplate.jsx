...
function LandingPageTemplate() {
  const batikUrl = import.meta.env.PROD ? '/blitar-keren/batik.svg' : '/batik.svg';
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-white" style={{width: '100vw', maxWidth: '100vw', margin: 0, padding: 0}}>
      ...
      <Sponsors />
      <Features />
      <div className="w-full px-8 py-12 my-8 relative z-0 bg-[#CC1720] overflow-hidden" style={{ backgroundImage: `url(${batikUrl})`, backgroundSize: '500px', backgroundRepeat: 'repeat' }}>
